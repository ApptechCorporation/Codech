...
public class HomeFragment extends Fragment {
                ...
                if (uri != null) {
                    ...
                    if (name != null) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                            path = Environment.getExternalStorageDirectory() + "/Codech";
                        } else {
                            path = Environment.getExternalStorageDirectory() + "/Codech";
                        }
                        ...
                        ImportProjectProgressFragment importProjectProgressFragment = ImportProjectProgressFragment.Companion.newInstance(uri);
    ...
    private final ActivityResultLauncher<
            Intent> documentPickerLauncher2 = registerForActivityResult(
    new ActivityResultContracts.StartActivityForResult(),
    result -> {
        if (result.getResultCode() == Activity.RESULT_OK) {
            Intent data = result.getData();
                ...
                new MaterialAlertDialogBuilder(requireContext())
                        ...
                        .setNegativeButton(
                                ...
                                (d, which) -> {
                                    ...
                                    setSavePath(
                                    Environment.getExternalStorageDirectory() + "/Codech/Projects");
                                })
                        .show();
