...
public class ProjectFragment extends Fragment {
    ...
    private final ActivityResultLauncher<String> zipContract = registerForActivityResult(
    ...
    uri -> {
        ...
        ExportProjectProgressFragment exportProjectProgressFragment = ExportProjectProgressFragment.Companion.newInstance(root.getAbsolutePath(), uri);
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                switch (which) {
                                    ...
                                    case 1:
                                        String message = getString(R.string.dialog_confirm_delete, project.getRootFile().getName());
                                        new MaterialAlertDialogBuilder(requireContext())
    ...
    private void checkIndexingThen(Runnable runnable) {
        ...
        boolean isCustomIndex = PreferenceManager.getDefaultSharedPreferences(ApplicationLoader.getInstance())
        ...
        Executors.newSingleThreadExecutor()
                .execute(
                        ...
                        String path = Environment.getExternalStorageDirectory()
                            ...
                            if (directories != null) {
                                Arrays.sort(directories, Comparator.comparingLong(File
                                        ::lastModified));
